        ...
        for i, det in enumerate(pred):  # per image
            ...
            if len(det):
                ...
                for c in det[:, -1].unique():
                    ...
                    total_person = n                                            #<====== add total_person=n
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    if save_img or save_crop or view_img:  # Add bbox to image
                        ...
                        font = cv2.FONT_HERSHEY_SIMPLEX                         #<===== add font
                        # Using cv2.putText() method
                        cv2.putText(im0, "Total people : "+f'{total_person}', (50,50), font, 
                                          1, (0,255,255), 2, cv2.LINE_AA)       #<===== add put text method
                        f.write('\n')                                           #<===== add f.write
                        f.write(f'{total_person}'+','+str(datetime.now()))
